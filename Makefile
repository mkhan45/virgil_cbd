...
generate_compiler: cbd_sexp
	cp defs/CanonicalDefs.v3 defs/CanonicalDefs.v3cbd
	$(VIRGIL) -fun-exprs -simple-bodies $(VIRGIL_STD) $(PARSER_DIR)/VirgilSexpr.v3 $(PARSER_DIR)/IR.v3 $(PARSER_DIR)/IRAnalysis.v3 compiler/CompilerGen.v3 defs/CanonicalDefs.v3cbd defs/CanonicalDefs.v3cbd.sexp compiler/CompilerTemplate.v3 > compiler/Compiler.v3
